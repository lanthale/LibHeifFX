...
class constants$11 {
    ...
    static final MethodHandle heif_image_get_color_profile_type$MH = RuntimeHelper.downcallHandle(
        heif_h.LIBRARIES, "heif_image_get_color_profile_type",
        "(Ljdk/incubator/foreign/MemoryAddress;)I",
        constants$11.heif_image_get_color_profile_type$FUNC, false
    );
    static final FunctionDescriptor heif_image_get_raw_color_profile_size$FUNC = FunctionDescriptor.of(C_LONG_LONG,
        C_POINTER
    );
    static final MethodHandle heif_image_get_raw_color_profile_size$MH = RuntimeHelper.downcallHandle(
        heif_h.LIBRARIES, "heif_image_get_raw_color_profile_size",
    ...
    static final MethodHandle heif_image_get_raw_color_profile$MH = RuntimeHelper.downcallHandle(
        heif_h.LIBRARIES, "heif_image_get_raw_color_profile",
    ...
    static final MethodHandle heif_image_get_nclx_color_profile$MH = RuntimeHelper.downcallHandle(
        heif_h.LIBRARIES, "heif_image_get_nclx_color_profile",
        "(Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;)Ljdk/incubator/foreign/MemorySegment;",
        constants$11.heif_image_get_nclx_color_profile$FUNC, false
    );
    static final FunctionDescriptor heif_decoding_options_alloc$FUNC = FunctionDescriptor.of(C_POINTER);
