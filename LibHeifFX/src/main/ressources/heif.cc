...
heif_image_handle* heif_context_get_primary_image_handle_alloc(heif_context* ctx)
{
  heif_image_handle* handle;
  heif_image_handle** img=&handle;
...
heif_image* heif_decode_image_alloc(const struct heif_image_handle* in_handle,                                    
                                    heif_colorspace colorspace,
                                    heif_chroma chroma,
                                    const struct heif_decoding_options* options)
{
  heif_image* imgret;	
  heif_image** out_img = &imgret;
